...
class DataReplicationServiceTest(unittest.TestCase):
    ...
    def test_retrieve_objects_returns_all_json_objects(self):
        # Arrange
        self.mock_external_data_service.get_objects.return_value = [{"object_name": "test", "bucket_name": "test_bucket", "is_dir": False, "size": 100, "etag": "test_etag", "last_modified": datetime.datetime(2018,11,1)}]
        # Act
        output = self.test_service.retrieve_objects()
        # Assert
        assert output[0] == {"object_name": "test", "bucket_name": "test_bucket", "is_dir": False, "size": 100, "etag": "test_etag", "last_modified": datetime.datetime(2018,11,1)}
