...
class DataReplicationService:
    ...
    def copy_dir(self, bucket_name, dir_path):
        ...
        self._internal_data_service.create_archive_file(dir_path, new_content=file_summary)
    ...
    def copy_new(self, bucket_name, dir_path):
        ...
        self._internal_data_service.create_archive_file(dir_path, new_content=files_summary)
        return return_transfer_summary(**transfer_summary)
